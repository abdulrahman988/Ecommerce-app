...
class SpecialProductRecyclerViewAdapter (private val onClickListener: OnClickListener)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ProductViewHolder {
        val binding = SpecialProductRvItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class ProductViewHolder(private val binding: SpecialProductRvItemBinding) :
